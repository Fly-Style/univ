...
public class Scheduling {
  ...
  private static int runtime = 9000;
  private static Vector <sProcess> processVector = new Vector();
  private static Results result = new Results("null","null",0);
  private static String resultsFile = "/Users/flystyle/Documents/Java Projects/L3.SPOS.Guaranteed Scheduler/src/Summary-Processes";
  ...
  private static void debug() {
    ...
    for (i = 0; i < size; i++) {
      ...
      System.out.println("process " + i + " " + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.numblocked + " " + process.rating);
    }
  ...
  public static void main(String[] args) {
    ...
    for (int j = 0; j < processVector.size(); j++) {
      System.out.println(processVector.get(j).cputime);
    }
